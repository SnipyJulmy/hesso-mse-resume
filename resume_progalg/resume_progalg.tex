...
\begin{center}
\begin{tikzpicture}
    \node[circle,draw,minimum size=0.7cm] (AA) at (0,2) {A};
    \node[circle,draw,minimum size=0.7cm] (AB) at (1,2) {B};
    \node[circle,draw,minimum size=0.7cm] (AC) at (2,2) {C};
    \node[circle,draw,minimum size=0.7cm] (BA) at (0,1) {D};
    \node[circle,draw,minimum size=0.7cm] (BB) at (1,1) {E};
    \node[circle,draw,minimum size=0.7cm] (BC) at (2,1) {F};
    \node[circle,draw,minimum size=0.7cm] (CA) at (0,0) {G};
    \node[circle,draw,minimum size=0.7cm] (CB) at (1,0) {H};
    \node[circle,draw,minimum size=0.7cm] (CC) at (2,0) {I};
    \draw (AA) -- (AB); 
    \draw (AB) -- (AC);
    \draw (AA) -- (BA);
    \draw (AB) -- (BB);
...
\begin{tikzpicture}
    ...
    \draw (A2) .. controls +(down:1cm) and +(down:1cm) ..  (A);
    \draw (A12) .. controls +(up:1cm) and +(up:1cm) ..  (A1);

    \draw (B2) .. controls +(down:1cm) and +(down:1cm) ..  (B);
    \draw (B12) .. controls +(up:1cm) and +(up:1cm) ..  (B1);

    \draw (C2) .. controls +(down:1cm) and +(down:1cm) ..  (C);
    \draw (C12) .. controls +(up:1cm) and +(up:1cm) ..  (C1);

    \draw (D2) .. controls +(down:1cm) and +(down:1cm) ..  (D);
    \draw (D12) .. controls +(up:1cm) and +(up:1cm) ..  (D1);
